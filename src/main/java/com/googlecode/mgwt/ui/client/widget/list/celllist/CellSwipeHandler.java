...
/**
 * Objects that implement this interface receives {@link CellSwipeEvent}
 * events
 *
 * @author Bert van Brakel
 * @version $Id: $
 */
public interface CellSwipeHandler extends EventHandler {
	/**
	 * Call when a cell is swiped
	 *
	 * @param event the event containing more information about the cell
	 */
	public void onCellSwipe(CellSwipeEvent event);
}
